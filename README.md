...
3. Бот создаст собственную структуру SEOR: `📡 SEOR INFO`, `⌨️ SEOR COMMANDS`, `💬 SEOR COMMUNITY`, `🆘 SEOR SUPPORT`, `🎧 SEOR PRIVATE`, `📮 SEOR RESULTS`, закрытый `🛡️ SEOR STAFF` и по пять Lobby для каждой из четырёх лиг.
...
| Команда | Назначение |
|---|---|
| `/setup` | Синхронизировать структуру: добавить нужное и удалить лишнее в управляемых категориях; только администратор |
